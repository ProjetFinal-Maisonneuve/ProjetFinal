...
>
    <div class="flex flex-col items-center">
        ...
        <span class="text-sm text-icon transition-colors duration-400 group-hover:text-icon-hover group-active:text-neutral-600 font-heading {{ $active ? 'text-primary' : '' }}">{{ $label }}</span>
    </div> 
</a>